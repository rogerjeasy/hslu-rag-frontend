...
import { TrueFalseQuestion } from '@/types/practice-questions';
  ...
  return (
    ...
    >
      {options.map((option) => {
        ...
        const isCorrectOption = showResults && option.value === question.correctAnswer;
        // Determine if this option was incorrectly selected by the user
        const isIncorrectSelection = showResults && userAnswer === option.value && option.value !== question.correctAnswer;
