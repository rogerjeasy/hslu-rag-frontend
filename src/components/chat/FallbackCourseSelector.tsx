...
export default function FallbackCourseSelector({
  ...
  const {
    ...
    fetchCourses = async () => {},
    setSearchTerm = () => {},
    filteredCourses: storeCourses = []
  } = courseStore || {};
  
  // Use provided courses if available, otherwise fall back to store courses
  const availableCourses = providedCourses || storeCourses;
  ...
  useEffect(() => {
    const loadCourses = async () => {
      // If courses are provided directly, don't fetch from store
